...
const templates = {
    ...
    newClaim: (itemName, claimantName) => emailWrapper(`
        <td style="padding:0;">
    ...
    claimUpdate: (itemName, status, remarks) => emailWrapper(`
        <td style="padding:0;">
    ...
    newMessage: (senderName, itemName) => emailWrapper(`
        <td style="padding:0;">
    ...
    itemMatch: (itemName, matchType) => emailWrapper(`
        <td style="padding:0;">
